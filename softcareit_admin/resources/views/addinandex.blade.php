              ...
              <div class="content-wrapper">
                      ...
                      <div class="col-lg-6 grid-margin">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <form action="/submitinhistory" method="post">
                                      @csrf
                                      Select Date :<input type="date" name="date1"><br><br>
                                      ...
                                      Enter Income Amount
                                      <input type="text" name ="inamount" placeholder="Amount"><br><br>
                      ...
                      <div class="col-lg-6 grid-margin">
                          <div class="card">
                              <div class="card-body">
                                  ...
                                  <p class="card-description">
                                      Add Expenditure <code></code>
                                  </p>
                                  <form action="/submitexhistory" method="post">
                                      @csrf
                                      Select Date :<input type="date" name="date2"><br><br>
                                      ...
                                      <input type="text" name ="examount" placeholder="Amount"><br><br>
                                      <input type="submit" name="submit" class="btn btn-primary">
                                  </form>
                              </div>
                          </div>
                  ...
                  <div class="row">
                      <div class="col-lg-6 grid-margin stretch-card">
                          <div class="card">
                              <div class="card-body">
                                  <h4 class="card-title">Income List Table</h4>
                                  <p class="card-description">
...
--}}
                      ...
                      <div class="col-lg-6 grid-margin stretch-card">
                          <div class="card">
                              <div class="card-body">
                                  <h4 class="card-title">Expenditure List Table</h4>
                                  <p class="card-description">
