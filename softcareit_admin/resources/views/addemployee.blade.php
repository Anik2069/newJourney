...
<!-- Mirrored from www.urbanui.com/melody/template/pages/forms/addemployee.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Sep 2018 06:07:32 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="/addemp" method="post">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlSelect3">User Roles</label>
                        <select class="form-control form-control-sm" id="exampleFormControlSelect3" name="roles">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword4">Joining Date</label>
                        <input type="date" class="form-control" id="exampleInputPassword4" placeholder="" name="date1">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputCity1">Address</label>
                        <input type="text" class="form-control" id="exampleInputCity1" name="address" placeholder="Location">
                    </div>
...
<!-- Mirrored from www.urbanui.com/melody/template/pages/forms/addemployee.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Sep 2018 06:07:34 GMT -->
</html>
